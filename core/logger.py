...
def parse(args, stage=3):
    ...
    if stage == 1: # train noise model
        experiments_root = os.path.join(
            'experiments', '{}_stage1_{}'.format(opt['name'], get_timestamp()))
    elif stage == 2: # train diffusion model
        experiments_root = os.path.join(
            'experiments', '{}_stage2_{}'.format(opt['name'], get_timestamp()))
    elif stage == 3:
        experiments_root = os.path.join(
            'experiments', '{}_stage3_{}'.format(opt['name'], get_timestamp()))
