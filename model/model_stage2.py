...
import os
from model.mri_modules import CNN_latent, CNN
from model.mri_modules import noise_model2
...
class DDM2Stage2(BaseModel):
    def __init__(self, opt):
        super(DDM2Stage2, self).__init__(opt)
        self.opt = opt
    ...
    def save_network(self, epoch, iter_step, save_last_only=False):
        ...
        logger.info(
            'Saved model in [{:s}] ...'.format(le_path))
